...
export const PACKS: Pack[] = [
  ...
  },
  {
    ...
    price: "£3.99",
    badge: "Deep Lines",
    blurb: "5 lines · deep Chigoran · punish …d5 / …b5 · Exchange trap · Marshall anti",
    lines: [
      {
        id: "rd1",
      ...
      {
        id: "rd3",
        name: "Line 3 · Punish premature 4…b5 & 5…d6",
        plies: [
        ...
        side: "w",
        punishment: {
          // 4…b5 is the intentional premature pawn lunge (ply index 7)
          mistakePlyIndex: 7,
          banner: "⚠️ Opponent Blundered! Find the best punishment move.",
          prompt: "Black plays premature 4…b5 & 5…d6. Build the centre and punish the pin.",
          successExplanation:
            "White builds a strong pawn centre while Black wastes tempos moving pawns instead of pieces.",
        },
      },
      {
        id: "rd4",
        name: "Line 4 · Exchange trap awareness (5.Nxe5?)",
        // Train as Black: punish White's greedy 5.Nxe5?
        plies: [
          "e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Bxc6", "dxc6", "Nxe5", "Qd4",
        ],
        side: "b",
        punishment: {
          // White's intentional mistake is Nxe5 (ply index 8)
          mistakePlyIndex: 8,
          banner: "⚠️ Opponent Blundered! Find the best punishment move.",
          prompt: "White greedily takes on e5. Find 5…Qd4!",
          successExplanation:
            "Taking on e5 immediately allows 5…Qd4!, double-attacking the knight on e5 and the pawn on e4. Play 5.O-O or 5.d4 instead!",
        },
      },
      {
        id: "rd5",
        name: "Line 5 · Marshall Attack anti-system",
        plies: [
          "e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "Nf6", "O-O", "Be7",
