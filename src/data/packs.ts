...
export const PACKS: Pack[] = [
    ...
    lines: [
      {
        ...
        plies: ["e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "a6"],
        side: "w",
      },
      {
        id: "os2",
        name: "Line 2 · Dragon Variation",
        plies: ["e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "g6"],
        side: "w",
      },
      {
        id: "os3",
    ...
    lines: [
      {
        ...
        plies: ["e4", "e6", "d4", "d5", "e5", "c5", "c3", "Nc6", "Nf3"],
        side: "w",
      },
      {
        id: "fw2",
      ...
      },
      {
        ...
        plies: ["e4", "e6", "d4", "d5", "Nc3", "Bb4", "e5", "c5", "a3"],
        side: "w",
      },
      {
        id: "fw4",
        name: "Line 4 · Tarrasch Variation",
        plies: ["e4", "e6", "d4", "d5", "Nd2", "c5", "exd5", "exd5"],
        side: "w",
      },
      {
        id: "fw5",
        name: "Line 5 · Exchange Variation",
        plies: ["e4", "e6", "d4", "d5", "exd5", "exd5", "Nf3", "Bd6"],
        side: "w",
      },
    ],
  },
    ...
    lines: [
      {
        ...
        plies: ["e4", "c6", "d4", "d5", "e5", "Bf5", "Nf3", "e6"],
        side: "w",
      },
      {
        id: "caw2",
        name: "Line 2 · Advance Tal Variation",
        plies: ["e4", "c6", "d4", "d5", "e5", "Bf5", "h4", "h6", "g4"],
        side: "w",
      },
      {
        id: "caw3",
        name: "Line 3 · Classical Variation",
        plies: ["e4", "c6", "d4", "d5", "Nc3", "dxe4", "Nxe4", "Bf5", "Ng3", "Bg6"],
        side: "w",
      },
      {
        id: "caw4",
        name: "Line 4 · Two Knights Variation",
        plies: ["e4", "c6", "Nc3", "d5", "Nf3", "Bg4", "h3", "Bxf3"],
        side: "w",
      },
      {
        id: "caw5",
        name: "Line 5 · Fantasy Variation",
        plies: ["e4", "c6", "d4", "d5", "f3", "dxe4", "fxe4", "e5"],
        side: "w",
      },
    ],
  },
  {
    ...
    lines: [
      ...
      },
      {
        id: "qg5",
        name: "Line 5 · Exchange Variation",
        plies: ["d4", "d5", "c4", "e6", "Nc3", "Nf6", "cxd5", "exd5"],
        side: "w",
      },
    ],
  },
    ...
    lines: [
      {
        ...
        plies: ["d4", "d5", "Bf4", "Nf6", "e3", "c5", "c3", "Nc6", "Nf3"],
        side: "w",
      },
      {
        id: "lon2",
        name: "Line 2 · Jobava London",
        plies: ["d4", "d5", "Nc3", "Nf6", "Bf4", "c5", "e3", "a6"],
        side: "w",
      },
      {
        id: "lon3",
        name: "Line 3 · Vs. Early …c5",
        plies: ["d4", "Nf6", "Bf4", "c5", "e3", "Qb6", "Nc3"],
        side: "w",
      },
      {
        id: "lon4",
      ...
      },
      {
        ...
        plies: ["d4", "f5", "Bf4", "Nf6", "e3", "e6", "Nf3", "b6"],
        side: "w",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "Vienna Gambit · f4 strike after Nc3",
    lines: [
      {
        id: "vg1",
        name: "Line 1 · Vienna Gambit",
        plies: ["e4", "e5", "Nc3", "Nf6", "f4"],
        side: "w",
      },
      {
        id: "vg2",
        name: "Line 2 · Vienna Game quiet",
        plies: ["e4", "e5", "Nc3", "Nf6", "Bc4", "Nc6", "d3"],
        side: "w",
      },
      {
        id: "vg3",
        name: "Line 3 · Falkbeer-style reply",
        plies: ["e4", "e5", "Nc3", "Nf6", "f4", "d5", "fxe5", "Nxe4"],
        side: "w",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "Kieseritzky Gambit · classical attacking lines",
    lines: [
      {
        id: "kg1",
        name: "Line 1 · Kieseritzky Gambit",
        plies: ["e4", "e5", "f4", "exf4", "Nf3", "g5", "h4", "g4", "Ne5"],
        side: "w",
      },
      {
        id: "kg2",
        name: "Line 2 · King's Gambit Accepted main",
        plies: ["e4", "e5", "f4", "exf4", "Nf3", "Be7", "Bc4"],
        side: "w",
      },
      {
        id: "kg3",
        name: "Line 3 · Falkbeer Counter-Gambit",
        plies: ["e4", "e5", "f4", "d5", "exd5", "e4"],
        side: "w",
      },
    ],
  },
  ...
  },
  {
    ...
    lines: [
      ...
      },
      {
        ...
        plies: ["e4", "e6", "d4", "d5", "Nd2", "c5", "exd5", "Qxd5", "Ngf3", "cxd4"],
        side: "b",
      },
      {
        id: "f3",
        name: "Line 3 · Advance …Qb6",
        plies: ["e4", "e6", "d4", "d5", "e5", "c5", "c3", "Nc6", "Nf3", "Qb6"],
        side: "b",
      },
      {
        id: "f4",
        name: "Line 4 · Classical 4.Bg5",
        plies: ["e4", "e6", "d4", "d5", "Nc3", "Nf6", "Bg5", "Be7", "e5", "Nfd7"],
        side: "b",
      },
      {
        id: "f5",
        name: "Line 5 · Steinitz 5.f4",
        plies: ["e4", "e6", "d4", "d5", "Nc3", "Nf6", "e5", "Nfd7", "f4", "c5"],
        side: "b",
      },
      {
        id: "f6",
        name: "Line 6 · Exchange",
        plies: ["e4", "e6", "d4", "d5", "exd5", "exd5", "Nf3", "Bd6", "Bd3", "Ne7"],
        side: "b",
      },
      {
        id: "f7",
        name: "Line 7 · Rubinstein",
        plies: ["e4", "e6", "d4", "d5", "Nc3", "dxe4", "Nxe4", "Nd7", "Nf3", "Ngf6"],
        side: "b",
      },
      {
        id: "f8",
  ...
  },
  {
    ...
    lines: [
      ...
      },
      {
        ...
        plies: ["e4", "c6", "d4", "d5", "e5", "Bf5", "Nf3", "e6", "Be2", "c5"],
        side: "b",
      },
      {
        id: "ck3",
      ...
      },
      {
        ...
        plies: ["e4", "c6", "d4", "d5", "Nc3", "dxe4", "Nxe4", "Nd7", "Ng5", "Ngf6"],
        side: "b",
      },
      {
        id: "ck5",
        name: "Line 5 · 4…Nf6 Exchange",
        plies: ["e4", "c6", "d4", "d5", "exd5", "cxd5", "Bd3", "Nc6", "c3", "Nf6"],
        side: "b",
      },
      {
        id: "ck6",
        name: "Line 6 · Two Knights …Bg4",
        plies: ["e4", "c6", "Nc3", "d5", "Nf3", "Bg4", "h3", "Bxf3", "Qxf3", "e6"],
        side: "b",
      },
      {
        id: "ck7",
        name: "Line 7 · Advance …c5",
        plies: ["e4", "c6", "d4", "d5", "e5", "c5", "dxc5", "e6", "Nf3", "Bxc5"],
        side: "b",
      },
      {
        id: "ck8",
        name: "Line 8 · Classical 5.Bc4",
        plies: ["e4", "c6", "d4", "d5", "Nc3", "dxe4", "Nxe4", "Bf5", "Bc4", "e6"],
        side: "b",
      },
    ],
  },
  ...
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "Classical pin · …Bb4 vs Nc3",
    lines: [
      {
        id: "ni1",
        name: "Line 1 · Classical main",
        plies: ["d4", "Nf6", "c4", "e6", "Nc3", "Bb4"],
        side: "b",
      },
      {
        id: "ni2",
        name: "Line 2 · Rubinstein 4.e3",
        plies: ["d4", "Nf6", "c4", "e6", "Nc3", "Bb4", "e3", "O-O"],
        side: "b",
      },
      {
        id: "ni3",
        name: "Line 3 · Classical 4.Qc2",
        plies: ["d4", "Nf6", "c4", "e6", "Nc3", "Bb4", "Qc2", "O-O"],
        side: "b",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "…d5 on move 1 · Qa5 main line",
    lines: [
      {
        id: "sc1",
        name: "Line 1 · Main line …Qa5",
        plies: ["e4", "d5", "exd5", "Qxd5", "Nc3", "Qa5"],
        side: "b",
      },
      {
        id: "sc2",
        name: "Line 2 · Modern …Nf6",
        plies: ["e4", "d5", "exd5", "Nf6", "d4", "Nxd5"],
        side: "b",
      },
      {
        id: "sc3",
        name: "Line 3 · …Qd6 system",
        plies: ["e4", "d5", "exd5", "Qxd5", "Nc3", "Qd6"],
        side: "b",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "Hypermodern …d6 & …g6 vs 1.e4",
    lines: [
      {
        id: "pd1",
        name: "Line 1 · Classical system",
        plies: ["e4", "d6", "d4", "Nf6", "Nc3", "g6", "Nf3", "Bg7"],
        side: "b",
      },
      {
        id: "pd2",
        name: "Line 2 · Austrian Attack setup",
        plies: ["e4", "d6", "d4", "Nf6", "Nc3", "g6", "f4", "Bg7"],
        side: "b",
      },
      {
        id: "pd3",
        name: "Line 3 · 150 Attack ideas",
        plies: ["e4", "d6", "d4", "Nf6", "Nc3", "g6", "Be3", "Bg7", "Qd2"],
        side: "b",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "Solid …c6 · main line & exchange",
    lines: [
      {
        id: "sd1",
        name: "Line 1 · Main line",
        plies: ["d4", "d5", "c4", "c6", "Nf3", "Nf6", "Nc3", "dxc4"],
        side: "b",
      },
      {
        id: "sd2",
        name: "Line 2 · Exchange Variation",
        plies: ["d4", "d5", "c4", "c6", "cxd5", "cxd5", "Nc3", "Nf6"],
        side: "b",
      },
      {
        id: "sd3",
        name: "Line 3 · Semi-Slav bridge",
        plies: ["d4", "d5", "c4", "c6", "Nf3", "Nf6", "Nc3", "e6"],
        side: "b",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "…f5 systems · Classical & Leningrad",
    lines: [
      {
        id: "dd1",
        name: "Line 1 · Classical Dutch",
        plies: ["d4", "f5", "g3", "Nf6", "Bg2", "e6", "Nf3", "Be7"],
        side: "b",
      },
      {
        id: "dd2",
        name: "Line 2 · Leningrad Dutch",
        plies: ["d4", "f5", "g3", "Nf6", "Bg2", "g6", "Nf3", "Bg7"],
        side: "b",
      },
      {
        id: "dd3",
        name: "Line 3 · Stonewall setup",
        plies: ["d4", "f5", "c4", "e6", "g3", "Nf6", "Bg2", "d5"],
        side: "b",
      },
    ],
  },
  {
    ...
    isPremium: true,
    price: "£1.99",
    blurb: "…g6 without early …Nf6 · flexible hypermodern",
    lines: [
      {
        id: "md1",
        name: "Line 1 · Modern main",
        plies: ["e4", "g6", "d4", "Bg7", "Nc3", "d6"],
        side: "b",
      },
      {
        id: "md2",
        name: "Line 2 · Averbakh system",
        plies: ["e4", "g6", "d4", "Bg7", "c4", "d6", "Nc3", "Nf6"],
        side: "b",
      },
      {
        id: "md3",
        name: "Line 3 · …c6 & …d5 ideas",
        plies: ["e4", "g6", "d4", "Bg7", "Nc3", "c6", "f4", "d5"],
        side: "b",
      },
    ],
  },
    ...
    lines: [
      {
        ...
        plies: ["d4", "d5", "Nf3", "Nf6", "Bf4", "c5", "e3", "Nc6", "c3", "e6"],
        side: "w",
      },
      {
        id: "cw2",
      ...
      },
      {
        ...
        plies: ["e4", "e5", "d4", "exd4", "c3", "dxc3", "Bc4", "cxb2", "Bxb2"],
        side: "w",
      },
      {
        id: "cw5",
        name: "Line 5 · Blackmar-Diemer",
        plies: ["d4", "d5", "e4", "dxe4", "Nc3", "Nf6", "f3", "exf3", "Nxf3"],
        side: "w",
      },
      {
        id: "cw6",
      ...
      },
      {
        ...
        plies: ["c4", "e5", "Nc3", "Nf6", "g3", "d5", "cxd5", "Nxd5", "Bg2", "Nb6"],
        side: "w",
      },
      {
        id: "cw8",
      ...
      },
      {
        ...
        plies: ["e4", "e5", "Nf3", "Nc6", "Nc3", "Nf6", "d4", "exd4", "Nxd4"],
        side: "w",
      },
    ],
  },
  {
    ...
    price: "£3.99",
    badge: "Deep Lines",
    blurb: "5 lines · deep Chigorin · punish hasty …d5 · exploit early …b5/…d6 · Noah's Ark · Marshall anti",
    lines: [
      {
        id: "rd1",
        name: "Line 1 · Chigorin Main Line (22-ply)",
        plies: [
      ...
      },
      {
        ...
        punishment: {
          mistakePlyIndex: 13,
          banner: "⚠️ Opponent Inaccuracy! Find the best punishment move.",
          prompt: "Black plays a hasty 7…d5! Find the punishing sequence.",
          successExplanation:
            "Nxe5! exploits the pinned knight on c6 and wins a crucial central pawn.",
        },
      },
      {
        id: "rd3",
        name: "Line 3 · Exploit Inaccurate 4…b5 & 5…d6",
        plies: [
          "e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "b5", "Bb3", "d6",
          "c3", "Nf6", "d4",
        ],
        side: "w",
        punishment: {
          mistakePlyIndex: 9,
          banner: "⚠️ Opponent Inaccuracy! Punish the passive play.",
          prompt:
            "Black plays an inaccurate move order with 4…b5 and 5…d6. Take control of the centre!",
          successExplanation:
            "4…b5 is a playable but impatient choice; following up with an early …d6 (instead of developing …Nf6) lets White seize the centre at once with c3 and d4.",
        },
      },
      {
        id: "rd4",
        name: "Line 4 · Defuse Noah's Ark Trap",
        plies: [
          "e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "d6", "d4", "b5",
          "Bb3", "Nxd4", "Nxd4", "exd4", "Qxd4", "c5", "Qd5",
        ],
        side: "w",
        punishment: {
          mistakePlyIndex: 13,
          banner: "⚠️ Black attempts a trap! Counter-attack.",
          prompt: "Black tries the Noah's Ark idea. Find the accurate reply.",
          successExplanation:
            "Qd5! creates a dual threat against f7 and the a8-rook, shutting down Black's trap.",
        },
      },
      {
        id: "rd5",
        name: "Line 5 · Marshall Attack Anti-System (18-ply)",
        plies: [
          "e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "Nf6", "O-O", "Be7",
