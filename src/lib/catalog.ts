...
export const FREE_SAMPLE_LINE_IDS: Readonly<Record<string, readonly string[]>> = {
  ...
  "scotch": ["s1", "s2", "s8", "s13", "s10", "s19", "s20", "s21", "s22", "s23", "s24", "s25", "sg1", "sg2", "sg3", "sg4", "sg5", "sg6"],
};
