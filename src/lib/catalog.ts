...
export const VISIBLE_PACK_IDS = ["caro-kann-black", "qgd-black", "london-black", "d4-sidelines-black", "anti-sicilian-black"] as const;
...
/** True if the pack has no sample list (QGD, London, 1.d4 sidelines, and Anti-Sicilian all free) or the line is in it. */
 ...
 * Play SKU path. A fifth visible free pack must not unhide Lab+.
