...
export const VISIBLE_PACK_IDS = ["caro-kann-black", "qgd-black", "london-black", "d4-sidelines-black", "anti-sicilian-black", "nimzo-larsen-white", "italian-white", "ruy-white", "french-white", "alapin-white", "english-black", "kg-black", "scandinavian-white", "pirc-150-white"] as const;
...
/** True if the pack has no sample list (QGD, London, 1.d4 sidelines, Anti-Sicilian, Nimzo-Larsen, Italian, Ruy Lopez, French, Alapin, English, King’s Gambit, Scandinavian, and the 150 Attack all free) or the line is in it. */
