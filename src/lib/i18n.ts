...
const en: Dict = {
  ...
  "A strict opening trainer": "A strict opening trainer",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Only book moves count. Drill the line, meet the traps, and punish the error.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "There is no Play on and no game versus the computer. That mode is gone for good.",
  "See your packs": "See your packs",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Two Opening Traps and three Caro lines are free to start.",
...
const es: Dict = {
  ...
  "A strict opening trainer": "Un entrenador estricto de aperturas",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab es un entrenador estricto de aperturas. Practice con pistas y luego Test sin ninguna.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Solo cuentan las jugadas de libro. Entrena la línea, conoce las trampas y castiga el error.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "No hay Play on ni partida contra el ordenador. Ese modo se quitó para siempre.",
  "See your packs": "Ver tus packs",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Dos Opening Traps y tres líneas Caro son gratis para empezar.",
...
const zh: Dict = {
  ...
  "A strict opening trainer": "严格的开局训练",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab 是严格的开局训练。Practice 有提示，然后 Test 没有任何提示。",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "只有书谱着法算数。反复练这条线，认识陷阱，并惩罚错误。",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "没有 Play on，也没有对电脑下棋。这个模式已经永久去掉。",
  "See your packs": "查看你的棋包",
  "You can read this again from Menu, then Help.": "你可以在菜单里打开帮助，再读一遍。",
  "Read the trainer intro": "阅读训练介绍",
  "Two Opening Traps and three Caro lines are free to start.": "两个 Opening Traps 和三条 Caro 线路可以免费开始。",
  "Find the mate": "找出将杀",
  "Mate in one": "一步将杀",
  "Not mate": "不是将杀",
  Next: "下一题",
...
const fr: Dict = {
  ...
  "A strict opening trainer": "Un entraîneur d'ouvertures strict",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab est un entraîneur d'ouvertures strict. Practice avec des indices, puis Test sans aucun.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Seuls les coups du livre comptent. Répète la ligne, vois les pièges et punis l'erreur.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Il n'y a pas de Play on ni de partie contre l'ordinateur. Ce mode est retiré pour de bon.",
  "See your packs": "Voir tes packs",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Deux Opening Traps et trois lignes Caro sont gratuites pour commencer.",
...
const de: Dict = {
  ...
  "A strict opening trainer": "Ein strenger Eröffnungstrainer",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab ist ein strenger Eröffnungstrainer. Practice mit Hinweisen, dann Test ohne.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Nur Buchzüge zählen. Übe die Linie, lerne die Fallen und bestrafe den Fehler.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Es gibt kein Play on und kein Spiel gegen den Computer. Dieser Modus ist dauerhaft weg.",
  "See your packs": "Deine Packs ansehen",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Zwei Opening Traps und drei Caro-Linien sind zum Start kostenlos.",
...
const pt: Dict = {
  ...
  "A strict opening trainer": "Um treinador estrito de aberturas",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab é um treinador estrito de aberturas. Practice com dicas e depois Test sem nenhuma.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Só contam os lances de livro. Treina a linha, vê as armadilhas e castiga o erro.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Não há Play on nem jogo contra o computador. Esse modo saiu de vez.",
  "See your packs": "Ver os teus packs",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Duas Opening Traps e três linhas Caro são grátis para começar.",
...
const ru: Dict = {
  ...
  "A strict opening trainer": "Строгий тренажёр дебютов",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab — строгий тренажёр дебютов. Practice с подсказками, затем Test без них.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Считаются только книжные ходы. Дрели линию, узнай ловушки и накажи ошибку.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Нет режима Play on и нет игры с компьютером. Этот режим убран навсегда.",
  "See your packs": "К твоим пакам",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "Две Opening Traps и три линии Caro бесплатны для старта.",
...
const it: Dict = {
  ...
  "A strict opening trainer": "Un allenatore di aperture rigoroso",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab è un allenatore di aperture rigoroso. Practice con suggerimenti, poi Test senza.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Contano solo le mosse di libro. Ripeti la linea, conosci le trappole e punisci l'errore.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Non c'è Play on e non c'è partita contro il computer. Quella modalità è tolta per sempre.",
  "See your packs": "Vedi i tuoi pack",
  "You can read this again from Menu, then Help.": "Puoi rileggerlo da Menu, poi Aiuto.",
  "Read the trainer intro": "Leggi l'introduzione",
  "Two Opening Traps and three Caro lines are free to start.": "Due Opening Traps e tre linee Caro sono gratis per iniziare.",
...
const hi: Dict = {
  ...
  "A strict opening trainer": "सख्त ओपनिंग ट्रेनर",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab एक सख्त ओपनिंग ट्रेनर है। Practice में संकेत, फिर Test बिना संकेत के।",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "सिर्फ बुक मूव गिने जाते हैं। लाइन ड्रिल करें, ट्रैप जानें, और गलती को सजा दें।",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Play on नहीं है और कंप्यूटर के खिलाफ खेल नहीं है। वह मोड हमेशा के लिए हटा दिया गया है।",
  "See your packs": "अपने पैक देखें",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "दो Opening Traps और तीन Caro लाइनें शुरू करने के लिए मुफ़्त हैं।",
...
const ja: Dict = {
  ...
  "A strict opening trainer": "厳格なオープニング練習",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab は厳格なオープニング練習です。Practice はヒントあり、Test はヒントなし。",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "定跡手だけが正解です。ラインを反復し、トラップを知り、誤りを罰します。",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Play on もコンピュータ対戦もありません。そのモードは永久になくなりました。",
  "See your packs": "パックを見る",
  "You can read this again from Menu, then Help.": "メニューのヘルプからもう一度読めます。",
  "Read the trainer intro": "練習の紹介を読む",
  "Two Opening Traps and three Caro lines are free to start.": "Opening Traps が2つと Caro の3ラインは無料で始められます。",
...
const ar: Dict = {
  ...
  "A strict opening trainer": "مدرّب افتتاحيات صارم",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab مدرّب افتتاحيات صارم. Practice مع تلميحات، ثم Test بلا أي تلميح.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "نقلات الكتاب فقط هي التي تُحتسب. كرر الخط، تعرّف على الفخاخ، وعاقب الخطأ.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "لا يوجد Play on ولا لعب ضد الحاسوب. أُزيل هذا الوضع نهائيًا.",
  "See your packs": "اعرض حزمك",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "مصيدتان من Opening Traps وثلاثة خطوط Caro مجانية للبداية.",
...
const tr: Dict = {
  ...
  "A strict opening trainer": "Sıkı bir açılış antrenörü",
  "Opening Lab is a strict opening trainer. Practice with hints, then Test with none.": "Opening Lab sıkı bir açılış antrenörüdür. Practice ipuçlu, sonra Test ipucusuz.",
  "Only book moves count. Drill the line, meet the traps, and punish the error.": "Yalnızca kitap hamleleri sayılır. Hattı çalış, tuzakları gör ve hatayı cezalandır.",
  "There is no Play on and no game versus the computer. That mode is gone for good.": "Play on yok ve bilgisayara karşı oyun yok. Bu mod kalıcı olarak kalktı.",
  "See your packs": "Paketlerini gör",
  ...
  "Two Opening Traps and three Caro lines are free to start.": "İki Opening Trap ve üç Caro hattı başlangıç için ücretsiz.",
