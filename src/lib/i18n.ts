...
const en: Dict = {
  ...
  "No openings match “{query}”": "No openings match “{query}”",
...
const es: Dict = {
  ...
  "No openings match “{query}”": "Ninguna apertura coincide con “{query}”",
...
const zh: Dict = {
  ...
  "Clear search": "清除搜索",
  "No openings match “{query}”": "没有与“{query}”匹配的开局",
  "Daily tasks": "每日任务",
...
const fr: Dict = {
  ...
  "No openings match “{query}”": "Aucune ouverture ne correspond à « {query} »",
...
const de: Dict = {
  ...
  "No openings match “{query}”": "Keine Eröffnung passt zu „{query}“",
...
const pt: Dict = {
  ...
  "No openings match “{query}”": "Nenhuma abertura corresponde a “{query}”",
...
const ru: Dict = {
  ...
  "No openings match “{query}”": "Нет дебютов по запросу «{query}»",
...
const it: Dict = {
  ...
  "No openings match “{query}”": "Nessuna apertura corrisponde a “{query}”",
...
const hi: Dict = {
  ...
  "No openings match “{query}”": "“{query}” से कोई ओपनिंग मेल नहीं खाती",
...
const ja: Dict = {
  ...
  "Clear search": "検索をクリア",
  "No openings match “{query}”": "「{query}」に一致するオープニングはありません",
  "Daily tasks": "今日の課題",
...
const ar: Dict = {
  ...
  "No openings match “{query}”": "لا توجد افتتاحات تطابق “{query}”",
...
const tr: Dict = {
  ...
  "No openings match “{query}”": "“{query}” ile eşleşen açılış yok",
