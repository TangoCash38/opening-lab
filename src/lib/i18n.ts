...
const en: Dict = {
  ...
  "No openings match.": "No openings match.",
...
const es: Dict = {
  ...
  "No openings match.": "Ninguna apertura coincide.",
...
const fr: Dict = {
  ...
  "No openings match.": "Aucune ouverture ne correspond.",
...
const de: Dict = {
  ...
  "No openings match.": "Keine Eröffnung passt.",
...
const pt: Dict = {
  ...
  "No openings match.": "Nenhuma abertura corresponde.",
...
const ru: Dict = {
  ...
  "No openings match.": "Нет подходящих дебютов.",
...
const it: Dict = {
  ...
  "No openings match.": "Nessuna apertura corrisponde.",
...
const hi: Dict = {
  ...
  "No openings match.": "कोई ओपनिंग मेल नहीं खाती.",
...
const ja: Dict = {
  ...
  "Clear search": "検索をクリア",
  "No openings match.": "一致するオープニングはありません。",
  "Daily tasks": "今日の課題",
...
const ar: Dict = {
  ...
  "No openings match.": "لا توجد افتتاحات مطابقة.",
...
const tr: Dict = {
  ...
  "No openings match.": "Eşleşen açılış yok.",
