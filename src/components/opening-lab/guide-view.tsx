  ...
  return (
    <div>
      ...
      <Block title="1.d4 Sideline Survival Kit">
        ...
        Veresov, and the Blackmar-Diemer. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="Anti-Sicilian Survival Kit">
        Meet White's anti-Sicilians as Black: Alapin, Grand Prix, Closed,
        Smith-Morra, Rossolimo, and the Wing Gambit. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="Nimzo-Larsen Attack for White">
        Play the Nimzo-Larsen as White: 1.b3, Bb2, and the central plans against …e5, …d5, …c5,
        and the fianchetto. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="Italian Game Mastery for White">
        Play the Italian as White: quiet d3 systems, the Giuoco Piano, Two Knights, Evans Gambit, and the Hungarian. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="Ruy Lopez Mastery for White">
        Play the Ruy Lopez as White: Closed Spanish, Berlin, Exchange, Open, Marshall, and Schliemann. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="French Defence for White: Advance & Tarrasch">
        Meet the French as White: Advance, Tarrasch, Classical, Winawer, and Exchange. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Sicilian: The Alapin for White">
        Meet the Sicilian as White with the Alapin: 2.c3 and d4 against …Nc6, …d5, …Nf6, …e6, …d6, and …g6. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet 1.c4: The Symmetrical English for Black">
        Meet 1.c4 as Black with the Symmetrical English: Four Knights, Botvinnik, Hedgehog, and reversed-Sicilian centres. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Defend Against the King’s Gambit">
        Defend the King’s Gambit as Black: Knight’s Gambit, Fischer, Classical Accepted, Bishop’s Gambit, and Falkbeer. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Scandinavian Defence: White’s Safe Edge">
        Meet the Scandinavian as White: the queen lines, Modern 2…Nf6, Portuguese, and Icelandic. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Pirc & Modern Defence: The 150 Attack">
        Meet the Pirc and Modern as White with the 150 Attack: Be3, Qd2, and a supported centre. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Dutch Defence: The Fianchetto System for White">
        Meet the Dutch as White with the fianchetto: g3, Bg2, and c4 against Classical, Stonewall, and Leningrad. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Caro-Kann: Advance & Panov for White">
        Meet the Caro-Kann as White with the Advance and the Panov. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Defend Against the Evans Gambit for Black">
        Defend the Evans Gambit as Black: accepted Ba5 and Be7, and declined Bb6. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Englund Gambit: White’s Safe Route">
        Meet the Englund Gambit as White: take on e5, develop, and do not let the queen raid dictate the game. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>

      <Block title="How to Meet the Budapest Gambit: White’s Safe Route">
        Meet the Budapest as White: Alekhine 4.Bf4/e3/Nf3, the main-line Qd5, and the Fajarowicz. Practice the main book moves with the yellow hint. Then Test with none to prove you remember them. Play on from the setup if you want. 18 lines. £2.99.
      </Block>
